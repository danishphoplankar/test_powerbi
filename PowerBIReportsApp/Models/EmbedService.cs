...
namespace PowerBIReportsApp.Models
{
    public class EmbedService : IEmbedService
    {
        ...
        private static readonly string Username = sectionConfig["pbiUsername"]; //"danishphoplankar@gmail.com";
        ...
        public async Task<bool> EmbedDashboard()
        {
            ...
            try
            {
                ...
                using (var client = new PowerBIClient(new Uri(ApiUrl), m_tokenCredentials))
                {
                    ...
                    var dashboards = await client.Dashboards.GetDashboardsInGroupAsync(Guid.Parse(WorkspaceId));
                    ...
                    var tokenResponse = await client.Dashboards.GenerateTokenInGroupAsync(Guid.Parse(WorkspaceId), dashboard.Id, generateTokenRequestParameters);
        ...
        public async Task<bool> EmbedTile()
        {
            ...
            try
            {
                ...
                using (var client = new PowerBIClient(new Uri(ApiUrl), m_tokenCredentials))
                {
                    ...
                    var tiles = await client.Dashboards.GetTilesInGroupAsync(Guid.Parse(WorkspaceId), dashboard.Id);
                    ...
                    var generateTokenRequestParameters = new GenerateTokenRequest(accessLevel: "view");
                    var tokenResponse = await client.Tiles.GenerateTokenInGroupAsync(Guid.Parse(WorkspaceId), dashboard.Id, tile.Id, generateTokenRequestParameters);
        ...
        Task<bool> IEmbedService.EmbedTile()
        {
